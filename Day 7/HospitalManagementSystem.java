...
// Inheritance: Superclass for common attributes
class Person {
    private String id;
    private String name;
...
// Inheritance: Doctor inherits from Person
...
// Aggregation: Appointment has a Doctor and a Patient
class Appointment {
...
// Composition: Hospital manages lists of Doctors, Patients, and Appointments
class Hospital {
    private String name;
    private List<Doctor> doctors; // Composition
    private List<Patient> patients; // Composition
    private List<Appointment> appointments; // Composition/Aggregation
    ...
    // Bonus: Search doctor by specialization using Java Streams
...
public class HospitalManagementSystem {
    public static void main(String[] args) {
        ...
        // Schedule appointments (Aggregation)
        ...
        // Bonus: Search doctors by specialization using Streams
